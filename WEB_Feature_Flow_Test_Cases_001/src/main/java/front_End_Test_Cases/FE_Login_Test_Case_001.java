...
public class FE_Login_Test_Case_001 {

	ExtentSparkReporter sparkReport;
	ExtentReports extentReport;
	ExtentTest extentTest;
	ExtentTest extentNode;
	FE_Login_Test_Case_001 ProgramTakeScreenshot;
	static WebDriver driver;
	static String PathOfReport = ".\\WEB_Feature_Flow_Test_Cases_001\\Reports\\";
	static String NameOfReport = "FE_Login";
...
//	}
		...
		if (userIDField.equals("请输入帐号")) {
			...
			if (passwordField.equals("请输入密码")) {
				...
				if (eyeIcon.isEnabled()) {
					eyeIcon.click();
					ProgramTakeScreenshot = new FE_Login_Test_Case_001();
	...
	public void After_Login_Verify_User() throws InterruptedException {
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement userID_AfterLogin = driver.findElement(By.xpath("//body/header/div[@class='header_top_outside']/div[@class='header_top']/div[@class='header_bottom_right']/div/div[@class='header_bottom_after_login']/div[2]/a[1]"));
		String userID = "qctester01010101";
		String userID_AL = userID_AfterLogin.getText();
		if(userID_AL.equals(userID)) {
			extentNode.info("Logged in with = " + userID_AL);
			userID_AfterLogin.click();
		}
	}
